...
**Generated at:** 2026-02-15 15:36 UTC

**Sites tested:** 127.0.0.1_8000, iri-dev.ppg.es.net
...
| operationId | 127.0.0.1_8000 | iri-dev.ppg.es.net |
|---|---|---|
| GET /api/v1/account | ![][badge-missing] | ![][badge-missing] |
| GET /api/v1/account/capabilities | ![][badge-pass] | ![][badge-pass] |
| GET /api/v1/account/capabilities/{capability_id} | ![][badge-pass] | ![][badge-pass] |
...
| operationId | 127.0.0.1_8000 | iri-dev.ppg.es.net |
|---|---|---|
| DELETE /api/v1/compute/cancel/{resource_id}/{job_id} | ![][badge-extra-pass] | ![][badge-extra-pass] |
...
| GET /api/v1/account/projects/{project_id}/project_allocations/{project_allocation_id}/user_allocations | ![][badge-pass] | ![][badge-pass] |
| GET /api/v1/account/projects/{project_id}/project_allocations/{project_allocation_id}/user_allocations/{user_allocation_id} | ![][badge-pass] | ![][badge-pass] |
| GET /api/v1/compute/status/{resource_id}/{job_id} | ![][badge-extra-pass] | ![][badge-extra-pass] |
| GET /api/v1/facility | ![][badge-pass] | ![][badge-pass] |
| GET /api/v1/facility/sites | ![][badge-pass] | ![][badge-pass] |
| GET /api/v1/facility/sites/{site_id} | ![][badge-pass] | ![][badge-pass] |
...
| GET /api/v1/status/incidents | ![][badge-pass] | ![][badge-pass] |
| GET /api/v1/status/incidents/{incident_id} | ![][badge-pass] | ![][badge-pass] |
| GET /api/v1/status/incidents/{incident_id}/events | ![][badge-extra-pass] | ![][badge-extra-pass] |
| GET /api/v1/status/incidents/{incident_id}/events/{event_id} | ![][badge-extra-pass] | ![][badge-extra-pass] |
| GET /api/v1/status/resources | ![][badge-pass] | ![][badge-pass] |
| GET /api/v1/status/resources/{resource_id} | ![][badge-pass] | ![][badge-pass] |
| GET /api/v1/task | ![][badge-extra-pass] | — |
| GET /api/v1/task/{task_id} | ![][badge-extra-pass] | — |
| POST /api/v1/compute/job/{resource_id} | ![][badge-extra-pass] | ![][badge-extra-pass] |
| POST /api/v1/compute/status/{resource_id} | ![][badge-extra-pass] | ![][badge-extra-pass] |
...
| PUT /api/v1/compute/job/{resource_id}/{job_id} | ![][badge-extra-pass] | ![][badge-extra-pass] |
